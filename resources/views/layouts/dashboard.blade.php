    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
          ...
          <div id="collapseRoles" class="collapse" aria-labelledby="headingRoles" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">Role actions:</h6>
      ...
      <li class="nav-item">
        ...
        <div id="collapseRecords" class="collapse" aria-labelledby="headingRecords" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Record actions:</h6>
            <a class="collapse-item" href="{{ route('records.index') }}">Record List</a>
            <a class="collapse-item" href="{{ route('records.create')}}">Add Record</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
          ...
          <div id="collapseGenres" class="collapse" aria-labelledby="headingGenres" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">Genre actions:</h6>
              <a class="collapse-item" href="{{ route('genres.index') }}">Genre List</a>
              <a class="collapse-item" href="{{ route('genres.create')}}">Add Genre</a>
            </div>
          </div>
        </li>
